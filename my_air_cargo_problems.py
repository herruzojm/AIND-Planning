...
def air_cargo_p2() -> AirCargoProblem:
    ...
    existing = [('C1', 'SFO'), ('C2', 'JFK'), ('C3', 'ATL'), ('P1', 'SFO'), ('P2', 'JFK'), ('P3', 'ATL')]
    pos, neg = initial_state(existing, cargos, planes, airports)    
...
def air_cargo_p3() -> AirCargoProblem:
    ...
    existing = [('C1', 'SFO'), ('C2', 'JFK'), ('C3', 'ATL'), ('C4', 'ORD'), ('P1','SFO'), ('P2','JFK')]
    pos, neg = initial_state(existing, cargos, planes, airports)    
...
def initial_state(existing, cargos, planes, airports):
    pos = []
    neg = []

    for cargo in cargos:
        for airport in airports:
            if (cargo, airport) in existing:
                pos.append(expr('At({},{})'.format(cargo, airport)))
            else:
    ...
    for plane in planes:
        for airport in airports:
            if (plane, airport) in existing:
                pos.append(expr('At({},{})'.format(plane, airport)))
            else:
